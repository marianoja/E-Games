...
describe('User model', () => {
  ...
  describe('Default fields', () => {
    ...
    it('should not have a token when creating with password', () => User.create({
        email: 'valid@email.com',
        password: 'todobien'
      })
      .then((user) => {
    ...
    it('should have state `active` when  creating with password', () => User.create({
        email: 'valid@email.com',
        password: 'todobien'
      })
      .then((user) => {
